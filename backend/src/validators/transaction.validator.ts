...
export const baseTransactionSchema = z.object({
    ...
    amount: z.number().positive("Amount must be a positive").min(1),
    ...
    recurringInterval: z.enum([RecurringIntervalEnum.DAILY, RecurringIntervalEnum.WEEKLY, RecurringIntervalEnum.MONTHLY, RecurringIntervalEnum.YEARLY]).nullable().optional(),
